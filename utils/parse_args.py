...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--tb_dir", default="tb", help="Directory for tensorboard files"
    )
    ...
    parser.add_argument(
        "--epoch", default=0, type=int, help="Which epoch to start training at"
    )
    parser.add_argument(
        "--revision",
        type=str,
    ...
    parser.add_argument(
        "--num_frames", default=8, type=int, help="Which epoch to start training at"
    )
    parser.add_argument(
        "--dropout_rate",
        default=0.2,
